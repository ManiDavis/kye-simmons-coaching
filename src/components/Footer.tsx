  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        {/* Script logo */}
        <div>
          <p className="font-serif italic text-2xl leading-tight" style={{ color: "#fff" }}>
            Kye Simmons
          </p>
          <p className="font-display text-xs tracking-[0.3em] uppercase mt-0.5" style={{ color: "var(--gold)" }}>
            Coaching
          </p>
        </div>
      ...
      <p className="text-center text-xs mt-8" style={{ color: "rgba(255,255,255,0.3)" }}>
        © {new Date().getFullYear()} Kye Simmons Coaching. All rights reserved.
      </p>
    </footer>
  );
}
